...
export const baseEn = {
	...
	asciiCharset: 'Character set',
	charsetBinary: '01 binary',
	charsetClassic: 'Classic ramp',
	charsetLetters: 'Letters & digits',
	charsetMatrix: 'Matrix style',
	charsetSymbols: 'Symbols',
	customCharsetPlaceholder: 'Type custom characters\u2026',
	customCharsetHint: 'First = darkest, last = brightest. Any characters work.',
	selectClip: 'Select a clip to edit its properties',
	selectClipHint: 'Click a clip on the timeline to adjust timing, effects, transform, and colour.',
...
export const baseZh: Record<keyof typeof baseEn, string> = {
	...
	asciiCharset: '字符集',
	charsetBinary: '01 二进制',
	charsetClassic: '经典渐变',
	charsetLetters: '字母数字',
	charsetMatrix: '矩阵风',
	charsetSymbols: '纯符号',
	customCharsetPlaceholder: '输入自定义字符…',
	customCharsetHint: '顺序从暗到亮（首字符=最暗），支持任意字符。',
