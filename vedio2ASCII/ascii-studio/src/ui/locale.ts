...
const COPY = {
	en: {
		...
		asciiTreatment: 'ASCII TREATMENT', glyphTransform: 'Glyph Transform', enabled: 'Enabled', density: 'Density', glyphScale: 'Glyph scale', contrast: 'Contrast', edgeDetail: 'Edge detail', colourTreatment: 'Colour treatment',
	...
	'zh-CN': {
		...
		asciiTreatment: 'ASCII 参数', glyphTransform: '字符转换', enabled: '启用', density: '密度', glyphScale: '字形大小', contrast: '对比度', edgeDetail: '边缘细节', colourTreatment: '配色方案',
